...
// This file contains ported code from perfetto internals that was not callable
// directly from percetto's custom DataSource implementation. Everything in
// here should be removed once perfetto makes exposes the corresponding
// functionality in functions that can be called by percetto.
